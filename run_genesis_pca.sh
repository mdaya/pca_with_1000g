...
rdata_file=`basename $plink_bed_file | sed 's/.bed/.RData/' | sed 's/.BED/.RData/'`
log_file=`basename $plink_bed_file | sed 's/.bed/_GENESIS_stdout.log/' | sed 's/.BED/_GENESIS_stdout.log/'`
slide_max_bp=$2
r2_ld_threshold=$3
